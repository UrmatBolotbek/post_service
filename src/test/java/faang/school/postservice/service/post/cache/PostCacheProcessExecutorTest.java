...
class PostCacheProcessExecutorTest {
    ...
    private final PostCache postWithTags = buildPostCacheDtoWithTags(USER_ID, hashTags);
    private final PostCache postEmptyTags = buildPostCacheDtoWithTags(USER_ID, emptyHashTags);
    private final PostCache post = buildPostCacheDto(USER_ID);
    private final List<PostCache> postsWithTags = buildPostCacheDtosWithTags(NUMBER_OF_POSTS);
