...
class PostCacheServiceTest {
    ...
    @Mock
    private RedisTemplate<String, PostCache> redisTemplatePost;
    ...
    void testSavePostsByTag() {
        PostCache post = buildPostCacheDto(USER_ID, PUBLISHED_AT);
        ValueOperations<String, PostCache> valueOperations = mock(ValueOperations.class);
