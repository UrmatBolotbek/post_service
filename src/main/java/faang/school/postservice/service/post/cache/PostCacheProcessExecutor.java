...
public class PostCacheProcessExecutor {
    ...
    public void executeNewPostProcess(PostCache post) {
    ...
    @Transactional(propagation = Propagation.MANDATORY)
    public void executeUpdatePostProcess(PostCache post, List<String> primalTags) {
    ...
    @Transactional(propagation = Propagation.MANDATORY)
    public void executeDeletePostProcess(PostCache post, List<String> primalTags) {
    ...
    public void executeAddListOfPostsToCache(List<PostCache> posts, String tagToFind) {
